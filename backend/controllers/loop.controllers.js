...
export const uploadLoop = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error uploading loop: ${error.message}` });
  }
};
...
export const like = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error liking loop: ${error.message}` });
  }
};
...
export const comment = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error commenting on loop: ${error.message}` });
  }
};
...
export const getAllLoops = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error fetching loops: ${error.message}` });
  }
};
...
export const deleteLoop = async (req, res) => {
  try {
    ...
    if (loop.author.toString() !== req.userId.toString()) {
      return res
        .status(403)
        .json({ message: "You are not authorized to delete this loop" });
    }
    ...
    return res
      .status(500)
      .json({ message: `Error deleting loop: ${error.message}` });
  }
};
