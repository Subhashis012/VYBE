...
function Upload() {
  ...
  return (
    <div className="w-full h-[100vh] bg-black flex flex-col items-center">
      ...
      {!frontendMedia && (
        <div
          className="w-[80%] max-w-[500px] h-[250px] bg-[#0e1316] border-gray-800 border-2 flex flex-col justify-center items-center gap-[8px] mt-[15vh] rounded-2xl cursor-pointer hover:bg-[#353a3d]"
        ...
        >
          ...
          <div className="text-gray-400 text-[19px] font-semibold">
            Upload {uploadType}
          </div>
        </div>
      )}
          ...
          {mediaType === "image" && (
            <div className="w-[80%] max-w-[500px] h-[250px] flex flex-col items-center justify-center mt-[5vh]">
              ...
              {uploadType !== "story" && (
                <input
                  type="text"
                  className="w-full border-b-gray-400 border-b-2 outline-none px-[10px] py-[5px] text-white mt-[22px]"
