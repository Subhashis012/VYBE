      ...
      >
        <div className="w-[70px] h-[70px] border-2 border-black rounded-full cursor-pointer overflow-hidden">
          ...
          {!story && userName === "Your Story" && (
            <div>
              <FiPlusCircle className="text-black rounded-full w-[22px] h-[22px] absolute bg-white bottom-[8px] right-[10px]" />
            </div>
          )}
        </div>
      </div>
      <div className="text-white text-center text-[14px] truncate w-full">
        {userName}
      </div>
    </div>
  );
